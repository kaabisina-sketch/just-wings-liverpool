    ...
    <footer className="bg-gray-50 border-t-2 border-black py-12 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex justify-center gap-4 mb-6">
          <a href="https://www.instagram.com/justwingsuk/?hl=en" target="_blank" rel="noopener noreferrer" className="text-black hover:text-gray-500 transition-colors">
            <Instagram size={22} />
          </a>
          {/* TikTok icon (custom SVG as lucide doesn't have it) */}
          <a href="https://www.tiktok.com/@justwings19" target="_blank" rel="noopener noreferrer" className="text-black hover:text-gray-500 transition-colors">
