          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border-2 border-black">
            {[
              ...
              },
              {
                ...
                serves: "Serves 50+",
                price: "POA",
                includes: ["Unlimited Wings", "All Flavors", "Full catering team", "Custom branded setup"],
              },
            ].map((pkg, i) => (
              <div
                key={i}
              ...
              >
                {pkg.featured && (
                  <span className="text-xs font-black uppercase tracking-widest text-gray-400 mb-3">Most Popular</span>
                )}
